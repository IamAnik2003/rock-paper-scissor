...
con.forEach((element, index) => {
    element.addEventListener("click", () => {
        ...
        setTimeout(() => {
            ...
            setTimeout(() => {
                ...
                setTimeout(() => {
                    if (
                        ...
                        // Update computer's score and save to localStorage
                        count_computer++;
                        computer_score.innerText = count_computer;
                        if (isLocalStorageAvailable()) {
            ...
            }, 500);  // Delay for computer's pick
        }, 500);  // Delay after human pick
    });
});
...
function resetGameView() {
    ...
    scoreContainer.style.display = "flex";  // Re-display the score container
